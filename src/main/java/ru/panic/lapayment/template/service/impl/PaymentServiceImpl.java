...
public class PaymentServiceImpl implements PaymentService {
    ...
    private final String ETHEREUM_TRANSACTION_URL = "https://api.etherscan.io/api?module=account&action=txlist&address=" + ETHEREUM_WALLET + "&startblock=0&endblock=99999999&sort=desc&page=1&offset=5&apikey=" + ETHEREUM_API_KEY;
    ...
    public Payment createPayment(PaymentRequestDto paymentRequestDto) {
        ...
        payment.setRipple_amount(Math.round(((Double) payment.getAmount() / ripplePrice) * 1e3) / 1e3);
